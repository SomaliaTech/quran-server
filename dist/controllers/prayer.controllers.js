...
export const createOrUpdatePrayerTime = async (req, res) => {
    try {
        ...
        if (!fajr || !dhuhr || !asr || !maghrib || !isha) {
            return res.status(400).json({
                success: false,
                message: "Please provide all prayer times (fajr, dhuhr, asr, maghrib, isha)",
            });
        }
...
// };
// Helper function to get current prayer based on time
export const getCurrentPrayer = async (req, res) => {
    try {
